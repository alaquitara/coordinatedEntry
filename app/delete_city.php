...
<html>
    <head>
        ...
        <title>CS 340 Project: Delete City</title>
    ...
    <body>
		...
		<div class="container">
			<?php
			if(!($stmt = $mysqli->prepare("DELETE FROM cities WHERE id=?"))){
			...
			if(!$stmt->execute()){
				...
				echo "<p id='message'>Removed " . $stmt->affected_rows . " row from cities.</p>";
			}
			?>
		</div>
	</body>
