...
<?php
	...
	$mysqli = new mysqli("oniddb.cws.oregonstate.edu","laquitaa-db","XXXXXXXXXXXX","laquitaa-db");
	if($mysqli->connect_errno){
		echo "Connection error " . $mysqli->connect_errno . " " . $mysqli->connect_error;
		}

	if(!($stmt = $mysqli->prepare("SELECT id, name, zipcode, population FROM cities WHERE id=?"))){
...
<html>
    <head>
        ...
        <title>CS 340 Project: Update City</title>
    ...
    <body>
        ...
        <div class="container">
            <form method="post" action="update_city2.php">
				<fieldset>
                    ...
                    <div class="row">
                        <div class="form-group col-md-2">
							...
							<input type="number" class="form-control" id="zip" name="zipcode" value=
								<?php
									echo '"' . $zipcode . '">';
								?>
						</div>
						<div class="form-group col-md-4">
							...
							<input type="number" class="form-control" id="population" name="population" value=
								<?php
									echo '"' . $population . '">';
								?>
						</div>
