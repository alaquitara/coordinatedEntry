...
<html>
    <head>
        ...
        <title>CS 340 Project: Add Referrals</title>
    ...
    <body>
		...
		<div class="container">
			<?php
				if(!($stmt = $mysqli->prepare("INSERT INTO referrals(cid, oid) VALUES (?,?)"))){
				...
				if(!$stmt->execute()){
					...
					echo "<p id='message'>Added " . $stmt->affected_rows . " row to referrals.</p>";
				}
			?>
		</div>
	</body>
