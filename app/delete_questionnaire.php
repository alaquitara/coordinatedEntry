...
<html>
    <head>
        ...
        <title>CS 340 Project: Delete Questionnaire</title>
    ...
    <body>
		...
		<div class="container">
			<?php
				if(!($stmt = $mysqli->prepare("DELETE FROM questionnaire WHERE id=?"))){
			    ...
			    if(!$stmt->execute()){
			    	...
			    	echo "<p id='message'>Removed " . $stmt->affected_rows . " row from questionnaire.</p>";
			    }
			?>
		</div>
	</body>
