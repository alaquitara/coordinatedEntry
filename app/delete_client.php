...
<html>
    <head>
        ...
        <title>CS 340 Project: Delete Client</title>
    ...
    <body>
		...
		<div class="container">
			<?php
			if(!($stmt = $mysqli->prepare("DELETE FROM clients WHERE id=?"))){
		    ...
		    if(!$stmt->execute()){
		    	...
		    	echo "<p id='message'>Removed " . $stmt->affected_rows . " row from clients.</p>";
		    }
			?>
		</div>
	</body>
